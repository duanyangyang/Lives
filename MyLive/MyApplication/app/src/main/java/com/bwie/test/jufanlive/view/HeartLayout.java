...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private static int[] drawableIds = new int[]{R.drawable.li_room_praise_0, R.drawable.li_room_praise_1, R.drawable.li_room_praise_2, R.drawable.li_room_praise_3, R.drawable.li_room_praise_4, R.drawable.li_room_praise_5, R.drawable.li_room_praise_7, R.drawable.li_room_praise_8, R.drawable.li_room_praise_6, R.drawable.li_room_praise_9, R.drawable.li_room_praise_10, R.drawable.li_room_praise_11};
